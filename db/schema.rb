...
ActiveRecord::Schema[8.1].define(version: 2026_03_04_211138) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "pulses", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "pulse_interval"
  ...
  create_table "status_pages", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["pulse_id"], name: "index_status_pages_on_pulse_id"
  end
  ...
  add_foreign_key "status_pages", "pulses"
end
